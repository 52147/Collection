 ...
 * Each character is higher that it is wide, so these rectangles will look
 * taller than you might expect. - Inherits getOffset, setOffset, and drawAt
 * from the class ShapeBasics.
 *
 */
